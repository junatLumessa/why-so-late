...
We had quite little data (only for 365 days) since it took much time and memory to download it. The results could be improved by getting more data and examining more variables that could affect the trains being late. The high temperature changes and snow depths appears mostly in winter so even if they affect how much the trains are late in winter they won't help predicting that in summer.
